  <?php
	...
	if (isset($_GET["id"])) {
		...
		$content = "your bidding price is Rs" . $price . ".  Please stay with us to know your bidding result.<br> Thank you.";
		$contentF = "" . $to . " bid on your crop-" . $vehicle . ", Rs" . $price . ".  Please stay with us to know your bidding result.<br> Thank you.";
