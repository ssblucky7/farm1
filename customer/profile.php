                    ...
                    <div class="col-lg-8 order-lg-2">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item btn-secondary" style="float: right; right: 16%;    margin-top: -13px; background-color: blanchedalmond;">
                                <a data-target="#profile" data-toggle="tab" class="nav-link active">
                                    <h4>Deposit Balance:Rs <label style="font-family: Cambria,Times New Roman; font-stretch: expanded;"><?= $amount ?></label></h4>
                                </a>
                            </li>
