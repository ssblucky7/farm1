...
<div class="container" style="min-height: 500px;">
	<div class="row">
		<div style=" margin-top: 60px;" id="heading">
			...
			<h4 style="text-align: center;">Winning Price:Rs <?= $bidprice ?></h4>
		...
		<div>
			<div style="margin-top: 50px;">
				<div style="text-align: justify;">
					...
					<strong>Bidders from the India: The only accepted payment methods for bidders are Net Banking and hand cash during delivery. We currently accept hand cash up to Rs 5,00,000. All payments Rs 5,00,000 or more must be made via Net Banking. </strong>
					...
					<p>
						Crop Auction currently does not accept international credit cards, credit cards or PayPal based outside of the Nepal, as a form of payment.</p>
				</div>
					...
					<div style="float: right;">
						<div class="col-sm-12  ">
							<ul style="font-size: 20px;">
								<li>
									<span>Delivery cost:Rs <label id="deliveryCost"> </label></span>


								</li>

								<li>
									<span>Bidding cost:Rs <label id="biddingCost"> <?= $bidprice ?> </label> </span>

								</li>
								<li>
									<span style="display: none;" id="mainCheck">Deposit amount (-):Rs <label id="depositCost"> <?= $amount ?> </label> </span>
									<input type="hidden" id="checking" value="">
								</li>
								<hr>
								<li class="divider"></li>
								<li class="total-price">
									<span>Total cost:Rs &nbsp; <label id="TotalCost"> </label> </span>
