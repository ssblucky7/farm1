                    ...
                    <div class="row">
                        <div class="col-sm-12 text-center">
                            ...
                            <div class="breadcrumb">
                                <a href="http://localhost/farm1/index.php">Home</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-sm-12">
                            ...
                            <ul class="list-inline shop-product-prices mb30" style="width: 330px;">
                                <li class="shop-red"><h4 >Base Price (Rs):<label id="basePrice"> <?=$price?></label> </h4></li>
                                 <li class="shop-red"><h4>Top Bid (Rs):<label id="topbidlevel"> </label></h4>   <input type="hidden" id="hidenvalue" value="<?php if(empty($_SESSION["topbid"])){echo(0);}else{echo($_SESSION["topbid"]);} ?>"> </li>
           ...
           <div class="container">
            	...
            	<label>Bank information for deposit amount</label><br/>
          	  	<span>Bank: Nepal National Bank</span><br/>
           	  	...
           	  	<span>Account No: 7657 7105 7778</span><br/><br/>
								...
								<div class="products grid-product mb30">
									<div class="product-grid-inner">
										...
										<div class="product-grid-caption text-center">
											...
											<h4>Base Price:<strong><?=$price?></strong> Rs</h4>
